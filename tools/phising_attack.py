...
class PhishingAttackTools(HackingToolsCollection):
    ...
    def pretty_print(self):
        ...
        for t in self.TOOLS:
            ...
            desc = self._get_attr(t, "DESCRIPTION", "Description", "description", "INSTALL_COMMANDS", default="") or ""
            url = self._get_attr(t, "PROJECT_URL", "PROJECT_URL", "PROJECT", "project_url", "projectUrl", default="") or ""
